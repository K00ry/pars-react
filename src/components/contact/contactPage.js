...
const ContactPage = props =>{
    ...
    const small = process.env.PUBLIC_URL + 'images/sizeset/new/intro2-mob.jpg';
    const medium = process.env.PUBLIC_URL + 'images/sizeset/new/intro2-tab.jpg';
    const large = process.env.PUBLIC_URL + 'images/sizeset/new/intro2-tab.jpg';
    return (
        <div className="main">
